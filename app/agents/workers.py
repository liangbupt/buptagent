...
def create_academic_agent(llm: ChatOpenAI):
    ...
    return create_react_agent(llm, tools=academic_tools, prompt=prompt)
...
def create_life_agent(llm: ChatOpenAI):
    ...
    return create_react_agent(llm, tools=life_tools, prompt=prompt)
...
def create_interaction_agent(llm: ChatOpenAI):
    ...
    return create_react_agent(llm, tools=interaction_tools, prompt=prompt)
